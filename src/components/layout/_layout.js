          ...
          <section
            ...
            >
              <svg t="1578910642710" className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1318" width="32" height="32">
                <path d="M295.62 386.32a95 95 0 1 1 95-95 95.11 95.11 0 0 1-95 95z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1319"></path>
                <path d="M295.62 216.32a75 75 0 1 1-75 75 75.09 75.09 0 0 1 75-75m0-40a115 115 0 0 0-115 115 115 115 0 0 0 115 115 115 115 0 0 0 115-115 115 115 0 0 0-115-115z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1320"></path>
                <path d="M506.18 351.15m-95 0a95 95 0 1 0 190 0 95 95 0 1 0-190 0Z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1321"></path>
                <path d="M506.18 276.15a75 75 0 1 1-75 75 75.09 75.09 0 0 1 75-75m0-40a115 115 0 0 0-115 115 115 115 0 0 0 115 115 115 115 0 0 0 115-115 115 115 0 0 0-115-115z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1322"></path>
                <path d="M722.06 414.23m-95 0a95 95 0 1 0 190 0 95 95 0 1 0-190 0Z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1323"></path>
                <path d="M722.06 339.23a75 75 0 1 1-75 75 75.09 75.09 0 0 1 75-75m0-40a115 115 0 0 0 0 230 115 115 0 0 0 0-230z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1324"></path>
                <path d="M852 530.53h-40v49.15h-69.94V425.69h-40v153.99H526.18V362.61h-40v217.07H315.62v-276.9h-40v276.9H212v-96.55h-40v364.55h40v-228h600v168h40V530.53z" fill={menuHover === 'edit' ? '#fff' : '#8888fa'} p-id="1325"></path>
              </svg>
              <span>花园</span>
            </section>
            <section
